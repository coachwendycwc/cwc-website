...
export const metadata: Metadata = {
  title: "Book a Discovery Call — Organizations | Coaching Women of Color",
  description:
    "Schedule a 30-minute discovery call with Wendy Perdomo to explore leadership coaching, workshops, and retreats for your organization.",
  robots: { index: false, follow: false },
};

export default function OrganizationsSchedulePage() {
  const motionLink =
    "https://app.usemotion.com/meet/wendy-perdomo/organizations";
  const accent = "#E91E8C";
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0D0D0D] via-[#1A1A2E] to-[#0D0D0D] flex flex-col">
      ...
      <main id="main-content" className="flex-1 flex flex-col items-center justify-center px-6 md:px-10">
        <div className="relative max-w-md w-full text-center">
          <div className="absolute -top-20 left-1/2 -translate-x-1/2 w-80 h-80 bg-[#E91E8C]/10 rounded-full blur-[120px]" />

          <div className="relative z-10">
            <div className="mb-6">
              <div
                className="w-20 h-20 md:w-24 md:h-24 rounded-full overflow-hidden ring-2 ring-offset-4 ring-offset-[#0D0D0D] mx-auto"
            ...
            <p className="mt-3 text-gray-400 text-sm leading-relaxed max-w-sm mx-auto">
              Explore how Coaching Women of Color&reg; can help your organization
              develop, retain, and elevate women of color in leadership.
            </p>
            ...
            <div className="mt-8 bg-white/[0.06] backdrop-blur-sm rounded-2xl border border-white/10 p-6 md:p-8">
              ...
              <ul className="space-y-2.5 mb-6 text-left">
                {[
                  ...
                  "Explore workshops, coaching & retreats",
