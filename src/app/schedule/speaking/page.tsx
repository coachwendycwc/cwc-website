...
export const metadata: Metadata = {
  title: "Book a Speaking Inquiry Call | Coaching Women of Color",
  description:
    "Schedule a 30-minute call with Wendy Perdomo to discuss keynotes, panels, workshops, and strategic retreats for your next event.",
        ...
        <div className="relative max-w-md w-full text-center">
          ...
          <div className="relative z-10">
            ...
            <p className="mt-3 text-gray-400 text-sm leading-relaxed max-w-sm mx-auto">
              Bring a powerful keynote, workshop, or strategic retreat to your
              next event. Let&apos;s discuss how Wendy can inspire your audience.
            </p>
            ...
            <div className="mt-8 bg-white/[0.06] backdrop-blur-sm rounded-2xl border border-white/10 p-6 md:p-8">
              ...
              <ul className="space-y-2.5 mb-6 text-left">
                {[
                  ...
                  "Explore keynotes, panels & workshops",
