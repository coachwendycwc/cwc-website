          ...
          <div className="container-wide">
            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              ...
              <div className="card-bordered">
                <div className="w-12 h-12 bg-[#FDE8F3] rounded-full flex items-center justify-center mb-6">
                  <svg className="w-6 h-6 text-[#E91E8C]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <ul className="mt-6 space-y-2 text-sm text-[#525252]">
                  <li className="flex items-center gap-2">
                    <svg className="w-4 h-4 text-[#E91E8C]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
