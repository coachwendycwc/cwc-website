  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: "We offer four pathways: the Leadership Clarity Session (a 90-minute deep dive), the 90-Day Executive Momentum Sprint (6 sessions), the Executive Leadership Coaching Program (6 months, 12 sessions), and the Executive Coaching Lab (a 10-month group program with community support).",
      },
      {
