...
const navigation = [
  {
    ...
    matchPaths: ["/for-organizations", "/services/strategic-retreats", "/services/executive-coaching", "/services/group-coaching", "/services/performance-coaching", "/services/virtual-series", "/services/workshops-webinars"],
  },
  {
    name: "Individuals",
